module Page.CalculateIEEEFloatingPointToDecimal exposing (..)
...
import Array
import Sharing as Sharing exposing (..)
...
viewsign model = viewSignIncrement model
...
viewhellomodel model = viewSignIncrement
